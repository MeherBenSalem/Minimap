...
public class MinimapHudRenderer {
    ...
    public static void drawBorder(GuiGraphics graphics, int x, int y, int size) {
    ...
    public static void drawCompass(GuiGraphics graphics, int x, int y, int size, float yaw) {
        Minecraft mc = Minecraft.getInstance();
        int cx = x + size / 2;
        int cy = y + size / 2;
        int r = size / 2 + 6;
