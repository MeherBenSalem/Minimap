...
public class TileCache {
    ...
    public TileCache(ColumnSampler sampler) {
    ...
    /**
     * Tile keys match the original plugin: each 128x128 tile stores world columns
     * [alignedX - 64, alignedX + 63], not [alignedX, alignedX + 127].
     */
    ...
    public void samplePixel(Level level, int worldX, int worldZ) {
        ...
        if (localX < 0 || localZ < 0 || localX >= Tile.SIZE || localZ >= Tile.SIZE) {
            return;
        }
