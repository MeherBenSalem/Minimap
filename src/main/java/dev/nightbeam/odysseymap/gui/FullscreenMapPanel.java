...
/**
 * Interactive map panel: receives drag/scroll input and renders terrain centered on pan.
 */
public class FullscreenMapPanel extends AbstractWidget {
    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        MinimapTexture texture = OdysseyMapClient.getMinimapTexture();
    ...
    /** Grid lines every 16 world blocks. */
